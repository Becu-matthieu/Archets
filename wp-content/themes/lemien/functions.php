...
function mes_scripts(){
	...
	wp_enqueue_script( 'geoloc', '/wp-content/themes/lemien/geoloc.js', 'googlemap', '1.0', false );
...
function get_content()
{
	...
	else
	{
		...
		$post = get_post($post_id);
		print "<div class=\"popup\"<h1>".$post->post_title."</h1> <br/>".$post->post_content."</div>";
